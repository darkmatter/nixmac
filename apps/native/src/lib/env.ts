...
export type EnvProfileKey = keyof typeof development | keyof typeof release | keyof typeof e2e;

type ProfileLookupKey = EnvProfileKey | "NIXMAC_VERSION" | "NIX_INSTALLED_OVERRIDE" | "VITE_POSTHOG_KEY";
...
export function getProfileValue(key: ProfileLookupKey): string | boolean | number | undefined {
