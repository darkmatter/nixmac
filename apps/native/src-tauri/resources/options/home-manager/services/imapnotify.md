...
| `services.imapnotify.path` | `list of package` | List of packages to provide in PATH for the imapnotify service. Note, this does not apply to the Darwin launchd service. |
