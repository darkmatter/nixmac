...
| `services.rescrobbled.settings` | `TOML value` | Configuration written to {file}`$XDG_CONFIG_HOME/rescrobbled/config.toml` See <https://github.com/InputUsername/rescrobbled#configuration> for the full list of options. |
