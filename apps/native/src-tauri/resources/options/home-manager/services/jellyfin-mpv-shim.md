...
| `services.jellyfin-mpv-shim.settings` | `JSON value` | Configuration written to {file}`$XDG_CONFIG_HOME/jellyfin-mpv-shim/conf.json`. See <https://github.com/jellyfin/jellyfin-mpv-shim#configuration> for the configuration documentation. |
