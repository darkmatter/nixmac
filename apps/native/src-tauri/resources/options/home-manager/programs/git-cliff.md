...
| `programs.git-cliff.settings` | `TOML value` | Configuration written to {file}`$XDG_CONFIG_HOME/git-cliff/cliff.toml`. See <https://git-cliff.org/docs/configuration> for the documentation. |
