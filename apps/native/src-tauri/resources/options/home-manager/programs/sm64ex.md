...
| `programs.sm64ex.settings` | `null or (attribute set of (string or signed integer or boolean or list of string))` | Settings for sm64ex's {file}`$XDG_DATA_HOME/sm64pc/sm64config.txt` file. |
