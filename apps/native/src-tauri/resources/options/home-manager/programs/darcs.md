...
| `programs.darcs.defaults` | `null or strings concatenated with "\n"` | Default values for Darcs commands. See <https://darcs.net/Using/Configuration#defaults> for details. |
