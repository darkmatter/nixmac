...
| `programs.halloy.themes` | `attribute set of (TOML value or strings concatenated with “\n” or absolute path)` | Each theme is written to $XDG_CONFIG_HOME/halloy/themes/NAME.toml . See https://halloy.chat/configuration/themes/index.html for more information. |
