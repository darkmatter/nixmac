...
| `programs.tiny.settings` | `YAML 1.1 value` | Configuration written to {file}`$XDG_CONFIG_HOME/tiny/config.yml`. See <https://github.com/osa1/tiny/blob/master/crates/tiny/config.yml> for the default configuration. |
