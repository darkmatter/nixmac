...
}:
{
  ...
  "@turbo/gen@2.10.1" = fetchurl {
    url = "https://registry.npmjs.org/@turbo/gen/-/gen-2.10.1.tgz";
    hash = "sha512-jH0F+BMoBmJ+ZvKCXg4VLLBJBnXBGrl+Vao+QwAQhmljoeOh4CKE4yrSH9TvGcacULQ+/Vd5Du1caIVRzCsKOg==";
  };
