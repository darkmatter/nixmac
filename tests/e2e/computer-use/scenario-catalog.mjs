...
export const screenshotAnnotations = freezeDeep({
  ...
  "evolved-screenshots-defaults-summary": [
    { label: "Screenshot defaults summary", x: 50, y: 38, tone: "pin" },
  ],
  "evolved-screenshots-defaults-diff": [
    { label: "Defaults diff evidence", x: 50, y: 45, tone: "pin" },
  ],
  "evolved-screenshots-defaults-after-discard": [
    { label: "Review-only cleanup", x: 50, y: 42, tone: "pin" },
  ],
  "adversarial-out-of-bounds-annotation": [
    { label: "Out of bounds fixture", x: 96, y: 50, w: 12, h: 10 },
  ],
});
    ...
    screenshots: [
      {
        ...
        probes: [{ label: "settings content panel", x: 12, y: 16, w: 80, h: 66 }],
      },
    ],
  },
  settingsAIModels: {
    screenshots: [
      {
        ...
        probes: [{ label: "provider and model controls", x: 12, y: 16, w: 80, h: 70 }],
      },
    ],
  },
  settingsPreferences: {
    screenshots: [
      {
        ...
        probes: [{ label: "preference controls", x: 12, y: 16, w: 80, h: 70 }],
      },
    ],
  },
  history: {
    screenshots: [
      { label: "history", probes: [{ label: "history surface", x: 10, y: 15, w: 82, h: 70 }] },
    ],
  },
  feedback: {
    screenshots: [
      { label: "feedback", probes: [{ label: "feedback dialog", x: 20, y: 18, w: 60, h: 60 }] },
    ],
  },
  reportIssue: {
    screenshots: [
      {
        label: "report-issue",
        probes: [{ label: "report issue dialog", x: 20, y: 18, w: 60, h: 60 }],
      },
    ],
  },
  suggestionCards: {
    screenshots: [
      {
        ...
        probes: [{ label: "prompt and suggestion area", x: 5, y: 35, w: 90, h: 34 }],
      },
    ],
  },
  typedIntent: {
    screenshots: [
      {
        label: "typed-intent",
        probes: [{ label: "typed prompt area", x: 5, y: 35, w: 90, h: 24 }],
      },
    ],
  },
  review: {
    screenshots: [
      {
        ...
        labels: [
          ...
          "provider-progress-04",
          "provider-progress-03",
          "provider-progress-02",
          "provider-progress-01",
        ],
    ...
    screenshots: [
      {
        ...
        probes: [{ label: "summary content area", x: 8, y: 15, w: 84, h: 78 }],
      },
    ],
  },
  diff: {
    screenshots: [
      { label: "review-diff", probes: [{ label: "diff content area", x: 8, y: 15, w: 84, h: 78 }] },
    ],
  },
  buildBoundary: {
    screenshots: [
      {
        ...
        probes: [{ label: "build confirmation dialog", x: 20, y: 22, w: 60, h: 56 }],
      },
    ],
  },
  saveFlow: {
    screenshots: [
      {
        label: "step-3-ready",
        probes: [{ label: "step 3 save surface", x: 8, y: 8, w: 84, h: 82 }],
      },
    ],
  },
  rollbackCleanup: {
    screenshots: [
      {
        label: "history-restore-preview",
        probes: [{ label: "restore confirmation preview", x: 12, y: 14, w: 76, h: 72 }],
      },
      {
        label: "after-history-restore",
        probes: [{ label: "post-restore app state", x: 8, y: 8, w: 84, h: 82 }],
      },
    ],
  },
  reportInspection: {
    screenshots: [
      {
        ...
        probes: [{ label: "rendered report body", x: 8, y: 8, w: 84, h: 82 }],
      },
    ],
  },
});
...
export const EVOLVED_CASE_CATALOG = freezeDeep({
  ...
  "screenshots-defaults": {
    ...
    source:
      "WDIO fixture basicPromptsConfigureScreenshots and eval CSV case 33 / golden-set system-defaults coverage.",
    defaultPrLane: false,
    expectedEvidence: [
      /screenshots?/i,
      /png/i,
      /~\/Screenshots|Screenshots/i,
      /defaults\.nix|screencapture/i,
    ],
  ...
  "inline-question-font": {
    ...
    prompt:
      "Ask the user one specific clarifying question before making any edits. After the user answers, make the requested nix/macOS configuration change.",
    answer: "Add a programming font",
    questionChoicePatterns: [/programming font/i, /\bfont\b/i],
    source:
      "Historical inline-question deadlock/race gap from PR #50/#53 plus WDIO ask-question fixture coverage.",
    defaultPrLane: false,
    expectedEvidence: [
      /font/i,
      /fonts\.nix|programming font|nerd font|font package/i,
      /Fira Code|JetBrains|nerdfonts?|programs\.fonts|fonts\s*=/i,
    ],
  ...
  "protected-flake-input": {
    ...
    source:
      "Eval spreadsheet protected-file family (#121/#208/#210). Not default because current app enforcement is prompt-level, not a hard backend guard.",
    defaultPrLane: false,
...
export const scenarioProofCatalog = freezeDeep({
  launch: {
    ...
    texts: ["launch"],
    proof:
      "Accessibility text shows the nixmac window, Settings/History/Feedback controls, stepper, prompt text area, and disabled Send button.",
  ...
  updateBanner: {
    ...
    texts: ["launch"],
    proof:
      "Runner checks for a visible Dismiss button. If present, it dismisses it; if absent, it proves no update banner blocked the initial UI.",
    untested:
      "The explicit dismiss interaction is only tested on runs where a banner is actually present.",
  },
  settingsGeneral: {
    grade: "action-confirmed",
  ...
  settingsAPIKeys: {
    ...
    proof:
      "API Keys screenshot is captured only when raw accessibility text confirms no unmasked key-like secret is present; redacted text must show API Keys/OpenRouter/API-key controls.",
  ...
  console: {
    ...
    texts: ["console"],
    proof:
      "Sensitive screenshot omitted; redacted accessibility text must show Console/log content.",
  ...
  diff: {
    ...
    untested:
      "Does not prove the change builds or saves; save/rollback scenarios provide that remote git proof.",
  },
  customizationSaveRollback: {
    grade: "action-confirmed",
    screenshots: [
      ...
      "customization-apply",
      "customization-step-3-ready",
      "customization-after-commit",
      "customization-after-history-restore",
    ],
    texts: [
      "customization-absent",
      "customization-apply",
    ...
    proof:
      "When the untracked customizations chip is visible, Computer Use adds it to config, confirms Build & Test, commits Step 3, then restores the disposable baseline and verifies the remote git tree is clean.",
    untested:
      "If no untracked customizations chip is visible, the scenario records a no-op pass because there is nothing to save.",
  },
  homebrewSaveRollback: {
    grade: "action-confirmed",
    screenshots: [
      "homebrew-absent",
      "homebrew-apply",
      "homebrew-step-3-ready",
      "homebrew-after-commit",
      "homebrew-after-history-restore",
    ],
    texts: [
      "homebrew-absent",
      "homebrew-apply",
    ...
    proof:
      "When the untracked Homebrew chip is visible, Computer Use adds it to config, confirms Build & Test, commits Step 3, then restores the disposable baseline and verifies the remote git tree is clean.",
    untested:
      "If no untracked Homebrew chip is visible, the scenario records a no-op pass because there is nothing to save.",
  },
  buildBoundary: {
    grade: "action-confirmed",
    ...
    proof:
      "Build & Test opens a confirmation dialog before activation; disposable runs confirm it and wait for Step 3.",
    untested:
      "Without explicit disposable build-confirm mode, the runner still cancels at the boundary.",
  },
  saveFlow: {
    grade: "action-confirmed",
    ...
    proof:
      "In disposable build-confirm mode, Computer Use reaches Step 3, clicks Commit, and the runner verifies the disposable repo HEAD changed with a clean worktree.",
  ...
  discard: {
    ...
    proof:
      "Discard opens a confirmation boundary when used. In full-lifecycle runs, the stronger History restore cleanup path can supersede Discard and is proven by rollback artifacts.",
    untested:
      "When History restore cleanup passes, Discard itself is intentionally not clicked because the disposable config is already back at baseline.",
  },
  evolvedScreenshotsDefaults: {
    ...
    proof:
      "Optional calibration case submits the screenshot-defaults prompt, reaches Review, checks for PNG/Screenshots/defaults evidence, and exits without Step 3.",
    untested:
      "Disabled in the default PR lane until its accessibility-text tokens are calibrated on the real remote app.",
  },
  inlineQuestionAnswer: {
    grade: "calibration",
    screenshots: [
      "evolved-inline-question-font-question",
      "evolved-inline-question-font-answered",
      "evolved-inline-question-font-summary",
      "evolved-inline-question-font-diff",
      "evolved-inline-question-font-after-discard",
    ],
    texts: [
      "evolved-inline-question-font-question",
      "evolved-inline-question-font-answered",
    ...
    proof:
      "Optional calibration case forces the provider into a user-question path, answers through the inline question UI, and requires progress to Review/Summary/Diff evidence.",
    untested:
      "Disabled in the default PR lane until repeated DXU runs prove the provider reliably takes the ask_user path.",
  },
  visualCoverage: {
    grade: "text-confirmed",
    screenshots: [
  ...
  visualProofQuality: {
    ...
    texts: [],
    proof:
      "Every passing scenario must have linked proof artifacts, and required non-sensitive screenshots must pass deterministic visual signal checks.",
    untested:
      "Visual signal checks catch missing, blank, occluded, or low-signal regions; they do not prove exact design fidelity or arbitrary wrong-screen swaps.",
  },
  adversarialOutOfBounds: {
    ...
    texts: [],
    proof:
      "Adversarial-only fixture used by run-adversarial.mjs to prove bad overlay geometry is caught.",
  ...
  mainCoverageFreshness: {
    ...
    texts: [],
    proof:
      "A repo-local coverage manifest maps major user-visible surfaces on main to Computer Use scenarios or explicit waivers, and the runner scans for unmapped candidate files.",
    untested:
      "This proves scenario mapping freshness, not that every mapped scenario passed in the current run.",
  },
  prSpecificCoverage: {
    grade: "not-run",
    screenshots: [],
  ...
  storybookPreview: {
    ...
    texts: [],
    proof:
      "Changed frontend UI files are mapped to built Storybook stories and direct reviewer URLs where applicable.",
    untested:
      "Storybook preview proves inspectable isolated UI states; it does not prove native app integration by itself.",
  },
  reportInspection: {
    grade: "action-confirmed",
    ...
    proof:
      "Computer Use opens the generated report or the Peekaboo CI lane verifies required report sections before publishing.",
